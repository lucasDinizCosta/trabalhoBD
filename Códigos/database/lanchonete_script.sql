...
CREATE TABLE filial ( nome VARCHAR(200) NOT NULL, cep VARCHAR(9) NOT NULL, cidade VARCHAR(200) NOT NULL, numero INTEGER NOT NULL, rua VARCHAR(200) NOT NULL, id_filial INTEGER PRIMARY KEY AUTO_INCREMENT );
...
CREATE TABLE gerente ( turno VARCHAR(200), grau BOOLEAN, id_pessoa INTEGER PRIMARY KEY, FOREIGN KEY(id_pessoa) REFERENCES funcionario (id_pessoa) );